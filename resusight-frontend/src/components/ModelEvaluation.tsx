...
const ModelEvaluation: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<
    "metrics" | "confusion" | "history" | "learning"
  >("metrics");
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const [metricsData, cmData, historyData, curvesData] =
        ...
        if (historyData.status === "fulfilled")
          setTrainingHistory(historyData.value);
        if (curvesData.status === "fulfilled")
          setLearningCurves(curvesData.value);
      } catch (err: any) {
    ...
    <div className="container mx-auto px-4 pb-20">
      <div className="text-center mb-12">
        ...
        <p className="text-slate-400 max-w-2xl mx-auto">
          Comprehensive analysis of our 7 AI models using standard performance
          metrics, confusion matrices, and training visualizations.
        </p>
      </div>
      ...
      <div className="bg-slate-950/50 border border-slate-800/50 rounded-2xl p-6 md:p-8 backdrop-blur-sm min-h-[500px]">
        ...
        {activeTab === "confusion" && (
          <div className="animate-fadeIn">
            ...
            <ConfusionMatrices
              matrices={
                confusionMatrices?.confusionMatrices || confusionMatrices
              }
              labels={confusionMatrices?.labels || []}
            />
          </div>
        )}
        ...
        {activeTab === "history" && (
          <div className="animate-fadeIn">
            <h3 className="text-xl font-bold text-white mb-6">
              Training History (Deep Learning & Transformer)
            </h3>
