...
class ModelLoader:
    def __init__(self, models_dir=None):
        ...
        If `models_dir` is not provided, assume `../models` relative to this file.
        The path is normalized to an absolute path to avoid incorrect relative joins.
        """
        if models_dir:
            # normalize provided path to absolute
            self.models_dir = os.path.abspath(models_dir)
        else:
            # default: models folder is a sibling of the repository root (one level up)
